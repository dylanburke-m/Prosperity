...
def trade_aco(state: TradingState, orders: List[Order]):
    ...
    #long 50, make bid less attractive by reducing by 2 ticks, and making ask more attractive by 2 ticks
    if   pos >  25: our_bid -= 1; our_ask -= 1
